# Python Windows process logger
Logging creation/stopping programs by name, pid and datetime
### Ubuntu/Unix:
```shell
$ git clone https://github.com/infnetdanpro/WindowsProcessLogger.git
$ virtualenv venv
...
Windows, run CMD.exe and run this commands:
```shell
